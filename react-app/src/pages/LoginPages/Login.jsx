    ...
    <div className="flex justify-center items-center align-middle h-[55vh]">
        <div>
            ...
            <form className="flex flex-col gap-y-2">
                <input type="text" name="identifier" value={user.identifier} onChange={handleChange} placeholder="Enter your username" className="rounded border-2 border-gray-200 w-full"/>
