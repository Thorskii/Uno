          ...
          <>
            <div className="flex flex-col md:flex-row md:flex-1 mx-auto gap-5 ">
              <div className="hidden md:flex md:flex-col md:flex-1 max-w-[150px]">
                ...
                <img className="w-full h-[150px] w-[150px] hidden lg:flex object-cover cursor-pointer mb-[10px] ml-[5px] border border-solid border-gray border-1" src={data?.attributes?.img2?.data?.attributes?.url} alt="" onClick={(e) => setSelectedImg("img2")} onError = {e => e.target.style.display = 'none'}/>
