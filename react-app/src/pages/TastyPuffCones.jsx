...
const Cones = () => {
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        document.title = "Tasty Puff Cones - Uno Distribution";  
      }, []);

    return (
    <div className="">
        <div className='relative p-5'>
            <h1 className="absolute font-bold text-4xl p-5 text-mushTitle left-0 lg:left-[220px] lg:-top-5">Tasty Puff Cones</h1>
        </div>
        ...
        <div className="py-6 flex flex-col md:flex-row">
            ...
            <div className="w-full flex flex-wrap justify-center ">
                <GetCards sort={sort} sortType={sortType} catId="6"/>
            </div>
